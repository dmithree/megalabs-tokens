...
var _reactDocgen = require("tt-react-docgen");

var _parse = require("tt-react-docgen/dist/parse");
...
function makeHandlers(node, handlers) {
  ...
  return [(0, _reactDocgenDisplaynameHandler.createDisplayNameHandler)(node.absolutePath || `/UnknownComponent${++fileCount}`), ...handlers];
}
