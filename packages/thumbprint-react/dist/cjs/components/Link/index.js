...
var Link = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(plain.default, _rollupPluginBabelHelpers.extends({}, getCommonLinkProps(props), {
    theme: props.theme,
...
var ThemedLink = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(themed.default, _rollupPluginBabelHelpers.extends({}, getCommonLinkProps(props), {
    icon: props.icon,
    theme: props.theme,
    size: props.size,
    width: props.width,
