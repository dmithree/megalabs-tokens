...
var Link = React.forwardRef(function (props, ref) {
  return React.createElement(Plain, _extends({}, getCommonLinkProps(props), {
    theme: props.theme,
...
var ThemedLink = React.forwardRef(function (props, ref) {
  return React.createElement(Themed, _extends({}, getCommonLinkProps(props), {
    icon: props.icon,
    theme: props.theme,
    size: props.size,
    width: props.width,
